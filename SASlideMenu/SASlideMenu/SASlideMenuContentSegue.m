...
-(void) perform{
    ...
    RootMenuTableVC* source = self.sourceViewController;
    ...
    SAMenuItem *selectedItem = [source.menuIndex objectAtIndex:selectedIndexPath.row];
    ...
    if ([rootController.leftMenu.slideMenuDataSource respondsToSelector:@selector(segueIdForIndexPath:)]) {
        [rootController addContentViewController:destination withAction:selectedItem.itemAction];
    }
